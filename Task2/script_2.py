...
class VacuumCleaner():
    ...
    def move(self):
        while self.battery_level != 0 and self.water_level != 0 and self.trash_level < 100:
            ...
            logging.info(print(VacuumCleaner.wash(self), VacuumCleaner.vacuum_cleaning(self)))
            logging.info(print("Battery level is:", self.battery_level))
            logging.info(print("Trash level is:", self.trash_level))
            logging.info(print("Water level is:", self.water_level))
